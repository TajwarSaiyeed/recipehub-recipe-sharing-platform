...
const FormImageInput: FC<FormImageInputProps> = ({ control, imageFile, handleFileChange, removeImage }) => (
                ...
                {imageFile ? (
                    <div
                        ...
                        <Image
                            fill
                            loading={"lazy"}
                            src={URL.createObjectURL(imageFile)} alt="Selected"
                            className={
                                "object-cover w-64 h-64 border border-zinc-100 rounded-xl"
                            }/>
                        <Button type="button" size={'icon'} onClick={removeImage}
